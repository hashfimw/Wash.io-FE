...
import {
  PendingOrdersCard,
  TodayOrdersCard,
} from "@/components/admin/RouterNavCard";

// Komponen wrapper untuk dashboard yang bisa di-refresh
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            <Button
              ...
              className=" hover:bg-birtu text-white border-white/20"
            >
              <RefreshCw
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-6">
        <Card className="hover:shadow-md transition-shadow">
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {dashboardData.outletsCount}
            </div>
            {isSuperAdmin && (
              <p className="text-xs text-green-600">
                +{dashboardData.newOutletsThisMonth} this month
              </p>
            )}
          </CardContent>
        </Card>
        ...
        <Card className="hover:shadow-md transition-shadow">
          ...
          <CardContent>
            ...
            <p className="text-xs text-green-600">
              +{dashboardData.newCustomersThisMonth} new customers
            </p>
          </CardContent>
        </Card>

        <PendingOrdersCard
          count={dashboardData.pendingOrdersCount}
          userRoleForPath={userRoleForPath}
        />

        <TodayOrdersCard
          count={dashboardData.todayOrdersCount}
          userRoleForPath={userRoleForPath}
        />
      </div>
