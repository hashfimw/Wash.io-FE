      ...
      <Card className="w-full">
        <CardContent className="p-4 sm:p-6">
          <div className="flex flex-col items-center justify-center h-64 text-center">
            <h3 className="text-lg sm:text-xl font-medium text-destructive">Error loading orders</h3>
      ...
      <Card className="w-full">
        <CardContent className="p-4 sm:p-6">
          <div className="flex flex-col items-center justify-center h-64 text-center">
            ...
            <h3 className="text-lg sm:text-xl font-medium">No pending orders</h3>
            ...
            >
              <div className="space-y-1 w-full sm:w-auto">
                <div className="flex flex-col sm:flex-row sm:items-center">
                  ...
                  <Badge variant="outline" className="mt-1 sm:mt-0 sm:ml-2 w-fit">
                    Arrived at Outlet
                  </Badge>
                </div>
                <p className="text-sm text-muted-foreground">{order.customerAddress.addressLine}</p>
