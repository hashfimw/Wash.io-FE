      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 mt-36">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Have questions about our laundry services? Reach out to us using the form below.
          </p>
        </div>
          ...
          <div className="bg-birmud rounded-lg shadow-lg p-8">
            ...
            <div className="mt-8">
              ...
              <div className="flex space-x-4">
                <a href="#" className="bg-birtu p-3 rounded-full text-putih hover:bg-oren transition-colors duration-300">
        ...
        {/* Map Section */}
        <div className="mt-16 bg-putih rounded-lg shadow-lg p-6">
          <h2 className="text-2xl font-semibold text-birtu mb-6 text-center">Find Us</h2>
          <div className="bg-birmud h-64 rounded-lg flex items-center justify-center">
            <div className="text-center">
              <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="mx-auto text-birtu mb-3">
                <path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z" />
                <circle cx="12" cy="10" r="3" />
              </svg>
              <p className="text-birtu">Map integration will appear here</p>
            </div>
          </div>
        </div>
      </div>
